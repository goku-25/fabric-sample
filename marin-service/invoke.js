...
function UserRegisteration(params) {
    ...
    return Promise.resolve().then(() => {
        ...
        var request = {
            ...
            fcn: 'registerUser',
            args: [UserDetails.uid, UserDetails.fname, UserDetails.lname, UserDetails.phone, UserDetails.email, UserDetails.usertype, UserDetails.password],
...
function consignmentdetail(params) {
    ...
    // var transactionString =  JSON.stringify(createProgram.transactionString);
...
function FetchPolicy(params) {
    ...
    var request = {
            ...
            targets: targets,
            chaincodeId: options.chaincode_id,
            fcn: 'fetchPolicyQuotes',
            args: [PolicyDetails.id, PolicyDetails.consignmentWeight, PolicyDetails.consignmentValue, PolicyDetails.invoiceNo, PolicyDetails.modeofTransport, PolicyDetails.packingMode, PolicyDetails.contractType, PolicyDetails.policyType, PolicyDetails.consignmentType],
